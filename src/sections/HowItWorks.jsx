        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          {steps.map((step, i) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group p-7 rounded-2xl border border-[#C9A45C]/20 bg-[#1F2E4F]
              hover:border-[#C9A45C]/60
              hover:shadow-[0px_10px_30px_rgba(201,164,92,0.2)]
            ...
            >
              ...
              {/* TITLE */}
              <h3 className="text-lg text-white font-semibold mb-2 group-hover:text-[#C9A45C] transition">
                {step.title}
              </h3>
