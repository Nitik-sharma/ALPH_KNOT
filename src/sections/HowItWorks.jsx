    ...
    <section className="py-28 bg-white">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.h2
          ...
          className="text-3xl md:text-5xl font-sans text-[#1F2E4F] text-center mb-16"
        >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          {steps.map((step, i) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group p-6 rounded-2xl border border-[#1F2E4F]/10 bg-white hover:border-[#C9A45C] hover:shadow-xl transition-all duration-300"
            >
              {/* ICON */}
              <div className="mb-4">{step.icon}</div>

              {/* STEP NUMBER */}
              <p className="text-sm text-[#C9A45C] font-sans mb-2">
                Step {i + 1}
              </p>

              {/* TITLE */}
              <h3 className="text-lg font-sans text-[#1F2E4F] mb-2 group-hover:text-[#C9A45C] transition">
                {step.title}
              </h3>
